...
# Minimum Spamming Tree : tree with n vertices n-1 edges with minimum weight of edges ie min sum of edge weight
Kruskal's Algorithm
Send Feedback
...
for i in range(E):
    ...
    src,dest,wt = curr_input[0],curr_input[1],curr_input[2]
